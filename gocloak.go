...
type GoCloak interface {
	...
	CheckLdapConnection(ctx context.Context, accessToken, realm, action, connectionUrl, authType, bindDn, bindCredential, useTruststoreSpi, connectionTimeout, startTls string) error
